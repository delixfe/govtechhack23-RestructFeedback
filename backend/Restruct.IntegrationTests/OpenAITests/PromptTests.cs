...
public class PromptTests {
    ...
    public async Task Summary() {
        ...
        var prompts = new List<ChatPrompt> {
            new("system", "Du bist ein präziser Assistent und drückst Dich so kurz wie möglich aus."),
            new(
                "user",
                $"""
            ...
            new("assistant", """Die Datei "entwurf.txt" enthält den Entwurf eines Bundesgesetzes."""),
            new("user", """Fasse den Inhalt der Datei "stellungnahme.txt" in 1 Satz zusammen."""),
        };
